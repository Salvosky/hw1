        ...
        <section>
            <?php
                ...
                if(!isset($_SESSION['username'])){
                    ...
                    echo "<h1>Per visualizzare una classe, devi effettuare l'accesso</h1>";
                    ...
                    if(mysqli_num_rows($res)>0){
                        ...
                        $cf=mysqli_fetch_row($res)[0];

                    }

                    $query="select cf from persone_db where id_scuola=".$_GET['Id_Scuola'];

                    $res=mysqli_query($conn, $query);

                    if(mysqli_num_rows($res)>0){

                        while($search=mysqli_fetch_assoc($res)){

                            if($search['cf']===$cf){

                                echo "<div id='login' class='hidden'></div>"; 
                    ...
                    if(isset($_GET['Id_Scuola'])){

                        $query="call op4(".$_GET['Id_Scuola'].")";
                        ...
                        if(mysqli_num_rows($res)>0){
                            ...
                            echo "<div id='average' class='hidden'>".$result[0]."</div>";
