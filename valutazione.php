        ...
        <section>
            <?php 
                if(isset($result['tipo'])){
                    ...
                    if($result['tipo']==="Alunno"){

                        echo "<p>Voti:</p><div id='showstudent'><div id='argument' class='hidden'>".$result['cf']."</div></div>";

                    }
                    else if($result['tipo']==="Insegnante"){

                        echo "<p>Voti assegnati:</p><div id='showteacher'><div id='argument' class='hidden'>".$result['cf']."</div></div>";

                    }
                    else echo "<div id='empty'><p>Non sei stato ancora inserito in un registro, contattare il docente</p></div>";
                }
            ?>
        </section>
        <footer>
